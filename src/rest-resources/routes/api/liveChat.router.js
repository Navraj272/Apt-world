...
liveChatRouter.route('/create-group').post(
  contextMiddleware(true),
  requestValidationMiddleware(createChatGroupSchema),
  isAdminAuthenticated(applicationModule.chatModule.create),
  LiveChatController.createChatGroup
)

liveChatRouter.route('/update-group').put(
  contextMiddleware(true),
  requestValidationMiddleware(updateChatGroupSchema),
  isAdminAuthenticated(applicationModule.chatModule.update),
  LiveChatController.updateChatGroup
)

liveChatRouter.route('/get-group').get(
  contextMiddleware(false),
  requestValidationMiddleware(getChatGroupsSchema),
  isAdminAuthenticated(applicationModule.chatModule.read),
  LiveChatController.getChatGroup
)

liveChatRouter.route('/get-group-users').get(
  contextMiddleware(false),
  requestValidationMiddleware(getChatGroupUsersSchema),
  isAdminAuthenticated(applicationModule.chatModule.read),
  LiveChatController.getChatGroupUsers
)

liveChatRouter.route('/get-group-chats').get(
  contextMiddleware(false),
...
liveChatRouter.route('/get-user-chats').get(
  contextMiddleware(false),
...
liveChatRouter.route('/get-reported-user').get(
  contextMiddleware(false),
...
liveChatRouter.route('/create-chat-rain').post(
  contextMiddleware(true),
...
liveChatRouter.route('/update-chat-rain').put(
  contextMiddleware(true),
...
liveChatRouter.route('/get-chat-rain').get(
  contextMiddleware(false),
...
liveChatRouter.route('/get-chat-rule').get(
  contextMiddleware(false),
...
liveChatRouter.route('/create-chat-rule').post(
  contextMiddleware(true),
...
liveChatRouter.route('/update-chat-rule').put(
  contextMiddleware(true),
...
liveChatRouter.route('/get-offensive-words').get(
  contextMiddleware(false),
...
liveChatRouter.route('/create-offensive-word').post(
  contextMiddleware(true),
...
liveChatRouter.route('/delete-offensive-word').delete(
  contextMiddleware(true),
  requestValidationMiddleware(deleteOffensiveWordSchema),
  isAdminAuthenticated(applicationModule.chatModule.read),
